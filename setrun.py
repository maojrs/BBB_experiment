...
#------------------------------
    ...
    clawdata.num_cells[0] = 600 #600 #400 #800 #1400 #1400 #3000 #700 #1500      # mx
    clawdata.num_cells[1] = 60 #60 #40 #80 #40 #40 # 40  #20      # my
    ...
    if clawdata.output_style==1:
        ...
        clawdata.num_output_times = 500 #15 #500 #400 #300 #200 #50
        clawdata.tfinal = 0.0002 #0.0001#0.0002 #0.00020 #0.0002 #0.0015 #0.0002 #0.0003 #0.0004 #0.03 #0.01 #0.050000
    ...
    clawdata.dimensional_split = 'unsplit' #'godunov'
