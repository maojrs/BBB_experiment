...
t, p = loadtxt('a-pgauge3.dat', unpack=True, usecols=[0,1])
# Load hydrophone gauge (change gauge number to change plot)
#th, ph = loadtxt('a-pgauge3hyd.dat', unpack=True, usecols=[0,1])
...
plt.legend([plt_non, plt_vap], ["Original", "Vapor pressure"])
plt.show()
