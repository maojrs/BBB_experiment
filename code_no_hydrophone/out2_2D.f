...
c     Extra variables for silo print
      dimension   qi(1:mx,1:my)
      dimension   gamma(1:mx,1:my), pinf(1:mx,1:my),rho(1:mx,1:my)
      dimension   momx(1:mx,1:my), momy(1:mx,1:my) , ene(1:mx,1:my)
      integer     nx,ny,fig
